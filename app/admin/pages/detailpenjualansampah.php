<?php
    include "../../koneksi.php";
    $id=$_GET['id'];
    $modal=mysqli_query($koneksi,"SELECT a.*, b.nama_pengepul, b.no_telp FROM tb_penjualan a INNER JOIN tb_pengepul b ON a.id_pengepul = b.id_pengepul WHERE a.id_penjualan='$id' LIMIT 1");
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content ">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Detail Penjualan Sampah | <?php echo $data['kode']; ?></h5>
        </div>
        <div class="modal-body">
           <div class="row">
                <div class="col-8">
                    <table>
                        <tr>
                            <td style="width:150px;padding:3px;">Kode Penjualan</td>
                        ...
                        <tr>
                            <td style="width:150px;padding:3px;">Pengepul</td>
                            <td><b><?php echo $data['nama_pengepul']; ?></b></td>
                        </tr>
                        <tr>
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $query2 = "SELECT * FROM tb_penjualan_detail WHERE kode_penjualan = '". $data['kode'] ."' ORDER BY jenis_sampah DESC"; 

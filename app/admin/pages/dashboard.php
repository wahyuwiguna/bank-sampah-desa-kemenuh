<?php
    ...
    $totpenjualansampah = array();
    $sumpenjualansampah = 0;
    $totpenjualansampahberat = array();
    $sumpenjualansampahberat = 0;
    ...
    for ($a=1; $a <= 12 ; $a++) { 
        $query_da = "SELECT COALESCE(sum(total_harga), 0) as total, COALESCE(sum(total_berat), 0) as jumlah FROM tb_penjualan WHERE MONTH(tanggal) = $a AND YEAR(tanggal) = $tahun";
        $sql_da = mysqli_query($koneksi, $query_da);
        $data_da = mysqli_fetch_array($sql_da);
        $totpenjualansampah[$a - 1] = $data_da['total'];
        $totpenjualansampahberat[$a - 1] = $data_da['jumlah'];
        $sumpenjualansampah += $data_da['total'];
        $sumpenjualansampahberat += $data_da['jumlah'];
    } 
                ...
                <div class="widget widget-one_hybrid widget-referral">
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                <p class="w-value"><?php echo $sumpenjualansampahberat; ?> Kg</p>
                                <h5 class="">Total Sampah Terjual</h5>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content">    
                ...
                <div class="widget widget-one_hybrid widget-engagement">
                    <div class="widget-heading">
                        <div class="w-title">
                            ...
                            <div class="">
                                <p class="w-value">Rp. <?php echo number_format($sumpenjualansampah); ?></p>
                                <h5 class="">Total Penjualan Sampah</h5>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content">    
                    ...
                    <div class="transactions-list">
                        <div class="t-item">
                            ...
                            <div class="t-rate rate-inc">
                                <p><span><?php echo $data['totberat']; ?> Kg</span></p>
                            </div>
                        </div>
                    </div>
  ...
  var d_1options4 = {
    ...
    series: [{
      ...
      data: [ 
        <?php 
            for ($p=0; $p < 12; $p++) {
            echo $totpenjualansampahberat[$p].",";

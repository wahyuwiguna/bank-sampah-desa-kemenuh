<?php
    ...
    //LOAD DATA
    $query = mysqli_query($koneksi, 'SELECT a.*, b.nama_pengepul FROM tb_penjualan a INNER JOIN tb_pengepul b ON a.id_pengepul = b.id_pengepul WHERE a.id_penjualan = '. $id.' LIMIT 1');
...
<div class="page-header">
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0);">Ubah Transaksi Penjualan Sampah - <?php echo $row['kode'] ?></a></li>
        </ol>
    </nav>
                ...
                <div class="row" style="margin: 15px;">
                        <div class="col-5">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-xl-10 col-lg-9 col-sm-10">
                                    <input id="pengepul" value="<?php echo $row['nama_pengepul']; ?>" class="form-control" type="text" style="color:black;" disabled>
                                </div>
                            </div>
                        </div>  
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            <div class="form-group form-group-default" style="text-align:right;">
                                ...
                                <br><br>
                                <a href="index.php?ref=datapenjualansampah.php" class="btn btn-outline-dark btn-rounded">Kembali</a>
...
$(document).ready(function() {
    ...
    $('#addRowButton').on('click', function() {
		...
		if(idjenissampah !=""){
			$.ajax({
				url: "proses/addpenjualandetail.php",
				type: "POST",
				data: {
                    kd: kd,
    ...
    $('#editRowButton').on('click', function() {
		...
		if(id !=""){
			$.ajax({
				url: "proses/updatepenjualandetail.php",
				type: "POST",
				data: {
                    kd: kd,
					id: id,
				...
				success: function(dataResult){
					...
					if(!dataResult.isError){
                        ...
                        swal({
                            title: 'Berhasil!',
                            text: "Jenis sampah berhasil diubah",
                            type: 'success',
                            showConfirmButton: false,
                            timer: 3000,
                            padding: '2em'
    ...
    $('#dtTable').on('click','.updateUser',function(){
        ...
        $.ajax({
            url: 'proses/loaddetailpenjualan.php',
            type: 'post',
            data: {id: id},
            success: function(dataResult){
    ...
    $('#dtTable').on('click','.deleteUser',function(){
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: 'proses/deletepenjualandetail.php',
                    type: 'post',
                    data: {id: id, kd: kd},
                    success: function(dataResult){
                        var dataResult = JSON.parse(dataResult);
...
function get_list() {
    ...
    $.ajax({
        url: 'proses/getdetailpenjualan.php',
        type: 'post',
        data: {kd: kd},
